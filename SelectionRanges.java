...
public class SelectionRanges implements java.io.Serializable, Constants {
	...
	***************************************************************************** */
	SelectionRanges readFromFile(String path) {
		SelectionRanges r = null;
		try (var fileIn = new FileInputStream(path); var in = new ObjectInputStream(fileIn)) {
			r = (SelectionRanges) in.readObject();
		} catch (IOException i) {
			i.printStackTrace();
